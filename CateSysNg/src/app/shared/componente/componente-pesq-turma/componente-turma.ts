...
@Component({
  ...
  templateUrl: './componente-turma.html',
  styleUrls: ['./componente-turma.css'],
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, InputNumber, InputTextModule, ButtonModule],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    multi: true,
    useExisting: forwardRef(() => ComponenteTurma)
  }],
})
export class ComponenteTurma implements ControlValueAccessor {
